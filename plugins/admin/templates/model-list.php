...
?>
      ...
      <tbody>
        ...
        <tr<?php echo $this->alternate(' class="alt"', '') ?>>
          <?php
$row = '';
foreach ($model_fields as $field) {
    $data = '';
...
?>
          ...
          <td><a href="<?php echo url_for('admin-model-edit', array('model' => $model_name, 'id' => $model->id, 'action' => 'delete')) ?>" class="delete-link">Delete</a></td>
        </tr>
        <?php endforeach ?>
      </tbody>
    </table>
